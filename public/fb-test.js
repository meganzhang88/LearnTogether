...
exports.main = function () {
    ...
    var db = config_1.config.database();
    // ----------------------------------------------------------------------------------- //
    // ----------------------------------------------------------------------------------- //
    var Chiazo = new User("Chiazo", "Agina", "CLAS", 51, -34, 45);
    // Try to write to and read back from Firebase.
    (function test() {
        return __awaiter(this, void 0, void 0, function () {
            var testUser, testUserSnapshot, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        testUser = db.ref("user/");
                        return [4 /*yield*/, testUser.push({
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, testUser.once("value")];
                    case 2:
                        testUserSnapshot = _a.sent();
